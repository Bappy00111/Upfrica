  ...
  return (
    <div>
      ...
      <div className=" bg-gray-100 py-8 px-2">
        <div className="bord  lg:w-3/5 space-y-2 bg-white shadow-md p-4 lg:p-8 rounded-md">
        ...
        {/* order cart  */}
        <div className="bord  lg:w-3/5 space-y-2 bg-white shadow-md p-4 lg:p-8 rounded-md mt-4">

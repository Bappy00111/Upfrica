        ...
        <table class="min-w-full bg-white cursor-pointer">
          <thead>
            <tr class="bg-gray-100 ">
              <th class="text-left py-2 px-4 hover:text-blue-500">id</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">
                Created At
              </th>
              <th class="text-left py-2 px-4 hover:text-blue-500">Full name</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">Username</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">Country</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">Email</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">Accounts</th>
              <th class="text-left py-2 px-4 hover:text-blue-500">
                Connected Accounts
              </th>
              <th class="text-left py-2 px-4 hover:text-blue-500"></th>
              <th class="text-left py-2 px-4 hover:text-blue-500"></th>
            </tr>
          </thead>
          <tbody>
            {data.map((item) => (
              ...
              >
                ...
                <Link to='UserEdit'><td className="py-2 px-4">Edit</td></Link>
